...
description: Keep code changes small, direct, and efficient in the multi_agent_ds repo. Use before adding or rewriting code, especially for Python analytics, pandas, NumPy, sklearn, SQL, helpers, abstractions, loops, dependencies, or parallel code paths.
---
