---
name: "Plan Alignment"
description: Align code changes with the multi_agent_ds planning docs before implementation. Use before coding, refactoring, adding files, introducing new layers, or taking on work that may conflict with project_planning architecture, build scope, or deferred future work.
---
