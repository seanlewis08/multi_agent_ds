...
description: Require explicit user confirmation before committing or pushing changes. Use at the end of any implementation, bug fix, refactor, or documentation task when work may be ready for git commit or git push.
---
